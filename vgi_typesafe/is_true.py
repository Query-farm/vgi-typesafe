    ...
    class Meta:
        ...
        tags = docs(
            ...
            llm=(
                ...
                "`UPDATE`. Compare it against a threshold; it is a probability, not a boolean. One "
                "request per distinct non-null value, and a NULL costs nothing and answers NULL. "
                "Use `noul()` "
            ...
            md=(
                ...
                "### What it cannot do\n\n"
                "A scalar takes no named arguments in DuckDB, so this is the whole signature: the "
                "default model, no criteria, no usage columns, and a question that is constant for "
                "the whole query. `noul()` is the same judgment with all of those, in "
                "table-function form.\n\n"
                "### Reading the answer\n\n"
